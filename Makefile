# This Makefile is for the Apache::SdnFw extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Apache/SdnFw.pm]
#     AUTHOR => q[A. U. Thor <chrissutton@localdomain>]
#     NAME => q[Apache::SdnFw]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Apache/SdnFw.pm]
...
FULLEXT = Apache/SdnFw
BASEEXT = SdnFw
PARENT_NAME = Apache
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Apache/SdnFw.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/Apache/SdnFw.pm \
	lib/Apache/SdnFw/lib/Core.pm \
	lib/Apache/SdnFw/lib/DB.pm

PM_TO_BLIB = lib/Apache/SdnFw.pm \
	blib/lib/Apache/SdnFw.pm \
	lib/Apache/SdnFw/lib/Core.pm \
	blib/lib/Apache/SdnFw/lib/Core.pm \
	lib/Apache/SdnFw/lib/DB.pm \
	blib/lib/Apache/SdnFw/lib/DB.pm
...
DISTNAME = Apache-SdnFw
DISTVNAME = Apache-SdnFw-1.00
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Apache/SdnFw.pm $(INST_MAN3DIR)/Apache::SdnFw.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         Apache-SdnFw' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      1.00' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Apache/SdnFw.pm' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>A. U. Thor &lt;chrissutton@localdomain&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/Apache/SdnFw.pm blib/lib/Apache/SdnFw.pm \
	  lib/Apache/SdnFw/lib/Core.pm blib/lib/Apache/SdnFw/lib/Core.pm \
	  lib/Apache/SdnFw/lib/DB.pm blib/lib/Apache/SdnFw/lib/DB.pm 
